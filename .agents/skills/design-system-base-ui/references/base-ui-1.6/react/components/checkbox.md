...
Snapshot: Base UI 1.6 / @base-ui/react@1.6.x
Fetched: 2026-06-23T22:10:15.337Z
Note: Base UI links were rewritten to local skill references.
-->
...
| parent          | `boolean`                                                                                   | `false`     | Whether the checkbox controls a group of child checkboxes. Must be used in a [Checkbox Group](./checkbox-group.md).                                           |
