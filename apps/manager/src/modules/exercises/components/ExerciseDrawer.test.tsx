...
import { RouteSurface } from '@/core/components/RouteSurface'
import { RouterPath } from '@/core/constants'

import { ExerciseDrawer } from './ExerciseDrawer'
import { exercisesDrawerRoutes } from '../router'
  ...
  return (
    <>
      ...
      <RouteSurface
        ...
        routes={[
          {
            children: exercisesDrawerRoutes,
            element: <ExerciseDrawer />,
            path: RouterPath.Exercise
          }
        ]}
      />
    </>
...
function renderApp(initialEntries: InitialEntries): ReturnType<typeof createMemoryRouter> {
  const router = createMemoryRouter([{ element: <Shell />, path: '*' }], { initialEntries })
