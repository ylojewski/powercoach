...
import { AUTHENTICATED_COACH_EMAIL, type Athlete, type GetCurrentRosterApiResponse } from '@/api'
import { RouterPath } from '@/core/constants'

import { RosterSidebar } from './RosterSidebar'
import { useRosterFeature } from '../hooks/useRosterFeature'

vi.mock('../hooks/useRosterFeature', () => ({
...
function mockRosterFeature(activatedAthlete?: Athlete): void {
  useRosterFeatureMock.mockReturnValue({
    ...
    activatedAthleteSlug: activatedAthlete ? 'kiro-flux' : null,
